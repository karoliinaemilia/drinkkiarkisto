...
class DrinkForm(FlaskForm):
    ...
    drinktype = SelectField("Juomalaji:", coerce=int, choices=drinktype_query())
    instructions = TextAreaField("Ohjeet: ", [validators.InputRequired(), validators.length(10, 500, message='Ohjeen on oltava vähintään 10 ja korkeintaan 500 merkkiä pitkä')])
